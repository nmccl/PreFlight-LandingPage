  ...
  return (
    <div className="relative mx-auto" style={{ width: 296, height: 296 }}>
      <svg width="296" height="296" style={{ transform: 'rotate(-90deg)', overflow: 'visible' }}>
        <circle cx="148" cy="148" r={r} fill="none" stroke="#E5E5EA" strokeWidth={strokeW} />
        <circle
          cx="148" cy="148" r={r}
          fill="none"
          stroke="#34c759"
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center select-none">
        <span className="text-[76px] font-bold tracking-[-0.04em] leading-none text-[#1d1d1f] tabular-nums">
          {count}
        </span>
        <span className="text-[15px] text-[#6e6e73] mt-2">out of 100</span>
      </div>
    </div>
  )
}
  ...
  return (
    <section className="py-10 px-6 bg-white">
      <div className="max-w-2xl mx-auto text-center">
        ...
        >
          <p className="text-[11px] font-semibold tracking-[0.22em] uppercase text-[#6e6e73] mb-5">
            Release Readiness
          </p>
          <h2 className="text-[52px] md:text-[64px] font-bold tracking-[-0.045em] leading-[1.02] text-[#1d1d1f]">
        ...
        >
          ...
          <p
            className="mt-10 text-[19px] text-[#6e6e73]"
            style={{
              opacity: ringIn ? 1 : 0,
